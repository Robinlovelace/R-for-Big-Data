...
Another alternative, could be to use cloud computing. For example, Amazon currently charge around \$0.15 per Gigabyte of RAM. Currently, a $244$GB machine, with 32 cores, costs around \$3.12 per hour\sidenote{\url{https://aws.amazon.com/ec2/pricing/}}.
