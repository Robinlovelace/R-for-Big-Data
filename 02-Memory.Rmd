...
\item Using Google, how much does it cost (in pounds) to double the amount of available RAM? For example, if you have 16GB of RAM, how much does that cost?
 ...
 * Three pointers: these are addresses to where memory is stored on the hard drive. One of the pointer is to a list of attributes. The other two pointers help R move between object on your hard drive.
