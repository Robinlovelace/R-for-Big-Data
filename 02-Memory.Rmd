...
Different data types, such as (ASCII) characters, integers and doubles, have different storage costs (see table \ref{T2.3}). In R, we don't tend to worry about characters, integers, or doubles. We tend to just let R do the thinking and conversion. However it is helpful to understand why files are large and the limits of the computer system.
