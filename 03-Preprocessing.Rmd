...
code:^[Note
that we use the same file name, `bn19figs.xlsx`, as the online version.
This helps ensure the data's provenance can be traced.]

```{r}
url <- "http://www.ifs.org.uk/bns/bn19figs.xlsx"
if(!file.exists("data/bn19figs.xlsx")){
  downloader::download(url, destfile = "data/bn19figs.xlsx")
}
```
