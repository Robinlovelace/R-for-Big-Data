...
- 'Wide' tables can become 'long', so that column names become a new variable. This is illustrated in Tables \ref{Tpew} to \ref{Tpewt} and can be acheived with the function `gather`:
