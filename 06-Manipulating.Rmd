...
**dplyr** has been carefully designed to make data analysis
fast and intuitive. **dplyr** works perfectly
on `data.frames` but it's default object is the `tbl`, which
