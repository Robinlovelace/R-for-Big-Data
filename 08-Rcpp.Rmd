...
To use the package you need a working C++ compiler. 
...
\begin{enumerate}
\item Construct an R version, `res_r` and compare the three function variants.
\item In the above example, `res_sugar` is faster than `res_c`. Do you know why?
\end{enumerate}
