...
Spark is rapidly becoming the a key component on analysing data sets that have to be distributed across multiple computers. To get an idea of Spark's popularity, browse the page
\begin{center}
